        ...
        <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-5 shadow-xl sm:p-6 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-start gap-3">
            ...
            >
              <svg viewBox="0 0 24 24" width="18" height="18" focusable="false">
                <path
                  d="M12 9v4m0 4h.01M10.3 4.3l-7.6 13.2A2 2 0 0 0 4.4 20h15.2a2 2 0 0 0 1.7-2.5l-7.6-13.2a2 2 0 0 0-3.4 0Z"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
          ...
          <div className="mt-5 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              className={
                'inline-flex w-full items-center justify-center rounded-2xl px-4 py-2 text-sm font-bold shadow-sm transition focus:outline-none focus:ring-4 sm:w-auto ' +
                (props.danger
